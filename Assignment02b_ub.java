...
public class Assignment02b_ub {
	...
	public static void main(String[] args) {
		...
		Log.printLine("space_share scheduling at VM level and at Cloudlet level .");
		...
		try {
			...
			int ram = 512; //vm memory (MB) is less than half on host memory as host has two VM
			long bw = 1000;
