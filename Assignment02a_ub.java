...
public class Assignment02a_ub {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting Cloud Lab experiment 02a usingCloudSim...");
		Log.printLine("1 Data center with 1 host having 2 CPU core  that receives request for 2 VM, each requiring 2 core ");
		...
		Log.printLine("CASE : time_share scheduling at VM level and at Cloudlet level .");
		...
		try {
			...
			// we do not have any bindings here
			...
			Log.printLine("CloudLab assignment 02a  finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	private static Datacenter createDatacenter(String name){
		...
		// In this example, it will have two core.
		...
		peList.add(new Pe(1, new PeProvisionerSimple(mips))); //2nd core added
		...
		//create another machine....we do not need that here
		/* 
