 ...
 */
public class MyCloudSimExample6 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			cloudletList = createCloudlet(brokerId,8); // creating 8 cloudlets
	...
	private static Datacenter createDatacenter(String name){
		...
		// we are not creating this quad core here .. so commented out 
		...
		// WE HAVE NOT BOUND THE CLOUDLET TO ANY VM
